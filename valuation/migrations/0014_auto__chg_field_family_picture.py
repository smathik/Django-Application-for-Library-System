...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'valuation_family', 'picture', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Family.picture'
        db.alter_column(u'valuation_family', 'picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
