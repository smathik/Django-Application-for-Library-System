...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'valuation_family', 'picture', self.gf('django.db.models.fields.CharField')(max_length=4000, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Family.picture'
        raise RuntimeError("Cannot reverse this migration. 'Family.picture' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Family.picture'
        db.alter_column(u'valuation_family', 'picture', self.gf('django.db.models.fields.CharField')(max_length=4000))
    ...
    models = {
        ...
        u'valuation.family': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'picture': ('django.db.models.fields.CharField', [], {'max_length': '4000', 'null': 'True', 'blank': 'True'}),
