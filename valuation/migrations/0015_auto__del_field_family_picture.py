...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Family.picture'
        db.delete_column(u'valuation_family', 'picture')
    ...
    def backwards(self, orm):
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Family.picture'
        db.add_column(u'valuation_family', 'picture',
    ...
    models = {
        u'valuation.attendance': {
            ...
            'date': ('django.db.models.fields.CharField', [], {'default': "'2014-08-13'", 'max_length': '11'}),
