...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'valuation_attendance', (
            ...
            ('date', self.gf('django.db.models.fields.CharField')(default='2014-08-11', max_length=11)),
        ))
    ...
    models = {
        u'valuation.attendance': {
            ...
            'date': ('django.db.models.fields.CharField', [], {'default': "'2014-08-11'", 'max_length': '11'}),
